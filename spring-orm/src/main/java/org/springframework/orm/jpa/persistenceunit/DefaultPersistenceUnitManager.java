		...
		implements PersistenceUnitManager, ResourceLoaderAware, LoadTimeWeaverAware, InitializingBean
{
	 ...
	 */
	public static final String DEFAULT_PERSISTENCE_XML_LOCATION = "classpath*:META-INF/"
	 ...
	 * <p>
	 * Default is "classpath:", that is, the root of the current classpath
	 ...
	 * it's simply "default".
	 * <p>
	 * <b>Note: There may be limitations in comparison to regular JPA scanning.</b>
	 ...
	 * <p>
	 * If no explicit {@link #setMappingResources mapping resources} have been
	 ...
	 * <p>
	 * It is not required to specify a LoadTimeWeaver: Most providers will be able
	 ...
	 * <p>
	 * Checks whether a "META-INF/orm.xml" file exists in the classpath and uses it
