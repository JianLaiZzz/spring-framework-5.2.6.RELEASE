...
public class LocalSessionFactoryBean extends HibernateExceptionTranslator
		implements FactoryBean<SessionFactory>, ResourceLoaderAware, BeanFactoryAware, InitializingBean,
		DisposableBean {
	...
	public void setBeanFactory(BeanFactory beanFactory) {
		if (beanFactory instanceof ConfigurableListableBeanFactory && ClassUtils.isPresent(
	...
	public void afterPropertiesSet() throws IOException {
		...
		LocalSessionFactoryBuilder sfb = new LocalSessionFactoryBuilder(this.dataSource,
