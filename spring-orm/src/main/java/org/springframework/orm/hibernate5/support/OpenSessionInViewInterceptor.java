 ...
 *
 * <p>
 * <b>WARNING:</b> Applying this interceptor to existing logic can cause issues
...
public class OpenSessionInViewInterceptor implements AsyncWebRequestInterceptor {
	...
	public void preHandle(WebRequest request) throws DataAccessException {
		...
		if (TransactionSynchronizationManager.hasResource(obtainSessionFactory())) {
			...
			AsyncRequestInterceptor asyncRequestInterceptor = new AsyncRequestInterceptor(
					obtainSessionFactory(), sessionHolder);
