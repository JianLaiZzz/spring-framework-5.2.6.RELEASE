...
public abstract class AbstractContainerEntityManagerFactoryIntegrationTests
	...
	public void testEntityManagerFactoryImplementsEntityManagerFactoryInfo() {
		...
		assertThat(emfi.getNativeEntityManagerFactory()).as("Raw EntityManagerFactory must be available")
				.isNotNull();
	}
	...
	public void testLazyLoading() {
		try {
			...
			Person newTony = entityManagerFactory.createEntityManager().getReference(Person.class,
					tony.getId());
