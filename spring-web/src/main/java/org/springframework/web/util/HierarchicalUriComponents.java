...
final class HierarchicalUriComponents extends UriComponents {
	 ...
	 */
	HierarchicalUriComponents(@Nullable String scheme, @Nullable String fragment,
							  @Nullable String userInfo, @Nullable String host, @Nullable String port,
							  @Nullable PathComponent path, @Nullable MultiValueMap<String, String> query, boolean encoded) {
		...
		this.queryParams = query != null ? CollectionUtils.unmodifiableMultiValueMap(query)
				: EMPTY_QUERY_PARAMS;
	...
	private HierarchicalUriComponents(@Nullable String scheme, @Nullable String fragment,
									  @Nullable String userInfo, @Nullable String host, @Nullable String port, PathComponent path,
									  MultiValueMap<String, String> queryParams, EncodeState encodeState,
	...
	HierarchicalUriComponents encodeTemplate(Charset charset) {
		...
		return new HierarchicalUriComponents(schemeTo, fragmentTo, userInfoTo, hostTo, this.port, pathTo,
	...
	public HierarchicalUriComponents encode(Charset charset) {
		...
		String fragmentTo = (fragment != null ? encodeUriComponent(fragment, charset, Type.FRAGMENT)
				: null);
		String userInfoTo = (this.userInfo != null
				? encodeUriComponent(this.userInfo, charset, Type.USER_INFO)
				: null);
		String hostTo = (this.host != null ? encodeUriComponent(this.host, charset, getHostType())
				: null);
	...
	protected HierarchicalUriComponents expandInternal(UriTemplateVariables uriVariables) {
		...
		return new HierarchicalUriComponents(schemeTo, fragmentTo, userInfoTo, hostTo, portTo, pathTo,
		...
		try {
			if (this.encodeState.isEncoded()) {
				...
				if (StringUtils.hasLength(path) && path.charAt(0) != PATH_DELIMITER) {
					...
					if (getScheme() != null || getUserInfo() != null || getHost() != null
							|| getPort() != -1) {
	...
	public boolean equals(@Nullable Object other) {
		...
		return (ObjectUtils.nullSafeEquals(getScheme(), otherComp.getScheme())
				...
				&& getPort() == otherComp.getPort() && this.path.equals(otherComp.path)
