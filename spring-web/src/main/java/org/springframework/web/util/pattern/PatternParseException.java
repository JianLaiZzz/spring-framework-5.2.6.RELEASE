...
public class PatternParseException extends IllegalArgumentException {
	...
	PatternParseException(Throwable cause, int pos, char[] pattern, PatternMessage messageType,
						  Object... inserts) {
	...
	public enum PatternMessage {
		...
		MISSING_CLOSE_CAPTURE(
				"Expected close capture character after variable name '}'"), MISSING_OPEN_CAPTURE(
