 ...
 *
 * <p>
 * This factory offers properties that in turn result in configuring the
 ...
 *
 * <p>
 * <strong>Deprecation Note:</strong> As of 5.2.4,
...
public class ContentNegotiationManagerFactoryBean
	 ...
	 * <p>
	 * The {@link #setFavorParameter(boolean) parameter strategy} requires
		...
		if (this.strategies != null) {
			...
			if (this.favorPathExtension) {
				...
				if (this.servletContext != null && !useRegisteredExtensionsOnly()) {
					strategy = new ServletPathExtensionContentNegotiationStrategy(this.servletContext,
							this.mediaTypes);
				} else {
