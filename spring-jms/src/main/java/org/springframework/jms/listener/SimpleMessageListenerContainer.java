...
public class SimpleMessageListenerContainer extends AbstractMessageListenerContainer
	...
	public void setConcurrency(String concurrency) {
		try {
			...
			if (separatorIndex != -1) {
				setConcurrentConsumers(Integer
	 ...
	 * <p>
	 * <b>Do not raise the number of concurrent consumers for a topic.</b>
	 ...
	 * <p>
	 * <b>NOTE: Specifying a TaskExecutor for listener execution affects
	 ...
	 * <p>
	 * <b>NOTE: Concurrent listener execution via a TaskExecutor will lead
	...
	protected void doInitialize() throws JMSException {
		if (!this.connectLazily) {
			try {
				...
				logger.debug("Could not connect on initialization - registering message consumers lazily",
						ex);
				return;
			}
			initializeConsumers();
