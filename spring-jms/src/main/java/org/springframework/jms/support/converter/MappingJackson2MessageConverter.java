...
public class MappingJackson2MessageConverter implements SmartMessageConverter, BeanClassLoaderAware {
	 ...
	 * <p>
	 * Default is none. <b>NOTE: This property needs to be set in order to allow
	 ...
	 * @throws IOException  in case of I/O errors
	 */
	protected Message mapToMessage(Object object, Session session, ObjectWriter objectWriter,
	...
	protected JavaType getJavaTypeForMessage(Message message) throws JMSException {
		...
		if (typeId == null) {
			throw new MessageConversionException("Could not find type id property ["
					+ this.typeIdPropertyName + "] on message [" + message.getJMSMessageID()
