		...
		implements JmsMessageOperations, InitializingBean
{
			...
			@Nullable MessagePostProcessor postProcessor)
	{
		...
		{
			return convertSendAndReceive(getRequiredDefaultDestinationName(), request, targetClass,
					postProcessor);
		}
	}
			...
			@Nullable MessagePostProcessor postProcessor)
	{
		...
		return (replyMessage != null ? (T) getMessageConverter().fromMessage(replyMessage, targetClass)
				: null);
	}
