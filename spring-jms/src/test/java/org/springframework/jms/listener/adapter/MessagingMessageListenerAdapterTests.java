...
public class MessagingMessageListenerAdapterTests {
	...
	public void headerConversionLazilyInvoked() throws JMSException {
		...
		assertThatIllegalArgumentException().isThrownBy(message::getHeaders)
	...
	public void replyPayloadToQueue() throws JMSException {
		...
		MessagingMessageListenerAdapter listener = getPayloadInstance("Response", "replyPayloadToQueue",
				Message.class);
	...
	public void replyPayloadToTopic() throws JMSException {
		...
		MessagingMessageListenerAdapter listener = getPayloadInstance("Response", "replyPayloadToTopic",
				Message.class);
		listener.onMessage(mock(javax.jms.Message.class), session);
	...
	public void replyPayloadToDestination() throws JMSException {
		...
		MessagingMessageListenerAdapter listener = getPayloadInstance("Response",
				"replyPayloadToDestination", Message.class);
		listener.onMessage(mock(javax.jms.Message.class), session);
	...
	public void replyPayloadNoDestination() throws JMSException {
		...
		MessagingMessageListenerAdapter listener = getPayloadInstance("Response",
				"replyPayloadNoDestination", Message.class);
	...
	public TextMessage testReplyWithJackson(String methodName, String replyContent) throws JMSException {
		...
		MessagingMessageListenerAdapter listener = getPayloadInstance("Response", methodName,
				Message.class);
