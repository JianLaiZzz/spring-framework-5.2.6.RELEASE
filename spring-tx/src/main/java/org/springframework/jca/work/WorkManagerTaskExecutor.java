...
public class WorkManagerTaskExecutor extends JndiLocatorSupport implements AsyncListenableTaskExecutor,
	...
	@Override
	public void doWork(Work work, long delay, ExecutionContext executionContext,
	...
	@Override
	public long startWork(Work work, long delay, ExecutionContext executionContext,
						  WorkListener workListener) throws WorkException {
	...
	@Override
	public void scheduleWork(Work work, long delay, ExecutionContext executionContext,
							 WorkListener workListener) throws WorkException {
