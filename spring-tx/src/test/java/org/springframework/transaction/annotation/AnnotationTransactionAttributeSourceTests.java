...
public class AnnotationTransactionAttributeSourceTests
{
	...
	public void serializable() throws Exception
	{
		...
		TransactionInterceptor serializedTi = (TransactionInterceptor) advised.getAdvisors()[0]
				.getAdvice();
	...
	public void customClassAttributeWithReadOnlyOverrideOnInterface() throws Exception
	{
		...
		assertThat(actual).as("Failed to retrieve TransactionAttribute for TestBean9.getAge()")
				.isNotNull();
	...
	public void customMethodAttributeWithReadOnlyOverrideOnInterface() throws Exception
	{
		...
		assertThat(actual).as("Failed to retrieve TransactionAttribute for TestBean10.getAge()")
				.isNotNull();
	...
	public void transactionAttributeDeclaredOnClassMethodWithEjb3() throws Exception
	{
		...
		AnnotationTransactionAttributeSource atas = new AnnotationTransactionAttributeSource();
		TransactionAttribute getAgeAttr = atas.getTransactionAttribute(getAgeMethod,
				Ejb3AnnotatedBean1.class);
		assertThat(getAgeAttr.getPropagationBehavior())
				.isEqualTo(TransactionAttribute.PROPAGATION_REQUIRED);
		TransactionAttribute getNameAttr = atas.getTransactionAttribute(getNameMethod,
				Ejb3AnnotatedBean1.class);
