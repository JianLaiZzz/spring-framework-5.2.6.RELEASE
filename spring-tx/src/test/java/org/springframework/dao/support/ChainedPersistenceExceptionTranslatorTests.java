...
public class ChainedPersistenceExceptionTranslatorTests
{
	...
	public void exceptionTranslationWithTranslation()
	{
		...
		assertThat(DataAccessUtils.translateIfNecessary(in1, chainedPet1)).as("Should not translate yet")
				.isSameAs(in1);
		chainedPet1.addDelegate(mpet1);
		assertThat(DataAccessUtils.translateIfNecessary(in1, chainedPet1)).as("Should now translate")
				.isSameAs(out1);
