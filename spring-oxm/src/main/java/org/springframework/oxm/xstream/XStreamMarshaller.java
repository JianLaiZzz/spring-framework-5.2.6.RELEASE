		...
		implements BeanClassLoaderAware, InitializingBean
{
	...
	protected XStream constructXStream()
	{
		return new XStream(this.reflectionProvider, getDefaultDriver(),
				new ClassLoaderReference(this.beanClassLoader), this.mapper, this.converterLookup,
	...
	public void marshalOutputStream(Object graph, OutputStream outputStream,
			@Nullable DataHolder dataHolder) throws XmlMappingException, IOException
	{
	 ...
	 */
	private void doMarshal(Object graph, HierarchicalStreamWriter streamWriter,
	 ...
	 * @param marshalling
	 *            indicates whether the exception occurs during marshalling ({@code true}),
