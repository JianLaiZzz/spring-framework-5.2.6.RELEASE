...
public class TigerAspectJExpressionPointcutTests
{
	...
	public void testMatchAnnotationOnClassWithSubpackageWildcard() throws Exception
	{
		...
		assertThat(springAnnotatedPc.matches(TestBean.class.getMethod("setName", String.class),
				TestBean.class)).isFalse();
		assertThat(
				springAnnotatedPc.matches(SpringAnnotated.class.getMethod("foo"), SpringAnnotated.class))
						.isTrue();
		...
		assertThat(springTxAnnotatedPc.matches(SpringAnnotated.class.getMethod("foo"),
				SpringAnnotated.class)).isFalse();
	}
	...
	private AspectJExpressionPointcut testMatchAnnotationOnClass(String expression) throws Exception
	{
		...
		assertThat(ajexp.matches(getAge, TestBean.class)).isFalse();
		assertThat(ajexp.matches(HasTransactionalAnnotation.class.getMethod("foo"),
	...
	public void testAnnotationOnMethodWithWildcard() throws Exception
	{
		...
		assertThat(anySpringMethodAnnotation.matches(
				...
				HasTransactionalAnnotation.class)).isFalse();
		assertThat(anySpringMethodAnnotation.matches(BeanA.class.getMethod("setName", String.class),
				BeanA.class)).isFalse();
	...
	public void testAnnotationOnMethodArgumentsWithFQN() throws Exception
	{
		...
		assertThat(takesSpringAnnotatedArgument2.matches(
				HasTransactionalAnnotation.class.getMethod("bar", String.class),
				HasTransactionalAnnotation.class)).isFalse();
		assertThat(takesSpringAnnotatedArgument2.matches(BeanA.class.getMethod("setName", String.class),
				BeanA.class)).isFalse();
		...
		assertThat(
				takesSpringAnnotatedArgument2.matches(
						ProcessesSpringAnnotatedParameters.class.getMethod("takesAnnotatedParameters",
								TestBean.class, SpringAnnotated.class),
		...
		assertThat(takesSpringAnnotatedArgument2.matches(
				ProcessesSpringAnnotatedParameters.class.getMethod("takesNoAnnotatedParameters",
						TestBean.class, BeanA.class),
