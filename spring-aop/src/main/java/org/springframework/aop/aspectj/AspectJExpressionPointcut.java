...
public class AspectJExpressionPointcut extends AbstractExpressionPointcut
	...
	public boolean matches(Method method, Class<?> targetClass, Object... args) {
		...
		try {
			...
			if (pmi != null && thisObject != null) { // there is a current invocation
				RuntimeTestWalker originalMethodResidueTest = getRuntimeTestWalker(
						getShadowMatch(method, method));
		...
		if (shadowMatch == null) {
			synchronized (this.shadowMatchCache) {
				...
				if (shadowMatch == null) {
					...
					if (shadowMatch == null) {
						shadowMatch = new ShadowMatchImpl(org.aspectj.util.FuzzyBoolean.NO, null, null,
								null);
	...
	public boolean equals(@Nullable Object other) {
		...
		return ObjectUtils.nullSafeEquals(this.getExpression(), otherPc.getExpression())
				&& ObjectUtils.nullSafeEquals(this.pointcutDeclarationScope,
				otherPc.pointcutDeclarationScope)
				&& ObjectUtils.nullSafeEquals(this.pointcutParameterNames, otherPc.pointcutParameterNames)
				&& ObjectUtils.nullSafeEquals(this.pointcutParameterTypes,
				otherPc.pointcutParameterTypes);
	}
	...
	private class BeanContextMatcher implements ContextBasedMatcher {
		...
		private FuzzyBoolean contextMatch(@Nullable Class<?> targetType) {
			...
			if (targetType != null) {
				...
				return FuzzyBoolean.fromBoolean(matchesBean(
		...
		private boolean matchesBean(String advisedBeanName) {
			return BeanFactoryAnnotationUtils.isQualifierMatch(this.expressionPattern::matches,
					advisedBeanName, beanFactory);
		}
	}
